...
import Settings from '../components/trade/settings';

// styling
import './trade.css';

export default function Trade({blockNumber, type}: {blockNumber:number, type:any}) {
  ...
  const [updatePriceStatus, setUpdatePriceStatus] = useState<boolean>(false);
    ...
    <div className="Trade">
      ...
      {settingsPopup == true && (
         <div className="settings-container">
           <Settings  popup={settingsPopup} setPopup={setSettingsPopup}
	     slipp={slippage} setSlipp={setSlippage} />
	 </div>
       )}
        {id && ( 
	 <>
	 ...
	 <div className="block-wrapper">
	   <div className="block-container">
		 ...
		 <div className="block-status">
             ...
             {blockNumber == 0 && id && (
	       <div className="block-status-sync-container">
