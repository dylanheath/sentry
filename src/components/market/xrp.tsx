...
// utils
import { xrpPrice } from '../../utils/price/xrp';
  ...
  return (
    <div className="market-component">
      <div className="market-component-header-container">
        <p className="market-component-header">XRP - USD</p>
	<div className="market-component-price-container">
      ...
      <p className="market-component-price-name">XRP</p>
