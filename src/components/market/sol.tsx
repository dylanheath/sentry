...
// utils
import { solPrice } from '../../utils/price/sol';
  ...
  return (
    <div className="market-component">
      <div className="market-component-header-container">
        <p className="market-component-header">SOL - USD</p>
	<div className="market-component-price-container">
      ...
      <p className="market-component-price-name">Solana</p>
